...
class SessionPropertiesTest {
    ...
    void rejectsBlankSecret() {
        ...
        assertThatThrownBy(() -> new SessionProperties("", "FACECOOK_SESSION", 604800, false, "Lax", null))
                .isInstanceOf(IllegalStateException.class);
        assertThatThrownBy(() -> new SessionProperties(null, "FACECOOK_SESSION", 604800, false, "Lax", null))
                .isInstanceOf(IllegalStateException.class);
    }
}
